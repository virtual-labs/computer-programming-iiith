...
$css_js   = "http://deploy.virtual-labs.ac.in/labs/cse02/"; 
$lab_url  = "http://deploy.virtual-labs.ac.in/labs/cse02/index.php";
$exp_url  =  "http://deploy.virtual-labs.ac.in/labs/cse02/exp10/index.php";
$base_url = $exp_url;
